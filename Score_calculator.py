...
print("Poäng för Ettor: ", score_ones(h))
print("Poäng för Tvåor: ", score_twos(h))  
print("Poäng för Treor: ", score_threes(h)) 
print("Poäng för Fyror: ", score_fours(h))  
print("Poäng för Femmor: ", score_fives(h))  
print("Poäng för Sexor: ", score_sixes(h))  
